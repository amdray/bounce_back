...
- **Расхождения** (см. полный список в аудите): неправильный alpha водных тайлов (3.5a), захардкоженный цвет фона (3.5b), отсутствие demo playback (5.11), отсутствие звука (5.12), минорные: drift тайминга 20 FPS (4.1), фаза tile animation (4.2).
